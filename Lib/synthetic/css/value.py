...
from ..prodparser import Choice, PreDef, Prod, ProdParser, Sequence

from ..helper import normalize, pushtoken
import colorsys
import re
import urllib.parse

from ..util import _NewBase
from ..serialize import *
from ..serialize import Preferences

newser = CSSSerializer(Preferences(indent='    '))
_ser = newser


class PropertyValue(_NewBase):
    """
    ...
    cssText = property(
        lambda self: _ser.do_css_PropertyValue(self),
        _setCssText,
    ...
    value = property(
        lambda self: _ser.do_css_PropertyValue(self, valuesOnly=True),
        doc="A string representation of the current value "
        "without any comments used for validation.",
    )


class Value(_NewBase):
    """
    ...
    cssText = property(
        lambda self: _ser.do_css_Value(self),
        _setCssText,
...
class ColorValue(Value):
    ...
    cssText = property(
        lambda self: _ser.do_css_ColorValue(self),
        _setCssText,
        doc="String value of this value.",
    )

    value = property(
        lambda self: _ser.do_css_CSSFunction(self, True),
...
class CSSFunction(Value):
    ...
    cssText = property(
        lambda self: _ser.do_css_CSSFunction(self),
        _setCssText,
        doc="String value of this value.",
    )
...
class MSValue(CSSFunction):
    ...
    cssText = property(
        lambda self: _ser.do_css_MSValue(self),
        _setCssText,
        doc="String value of this value.",
    )
...
class CSSCalc(CSSFunction):
    ...
    cssText = property(
        lambda self: _ser.do_css_CSSCalc(self),
        _setCssText,
...
class CSSVariable(CSSFunction):
    ...
    cssText = property(
        lambda self: _ser.do_css_CSSVariable(self),
        _setCssText,
    ...
    name = property(
        ...
        "a value in a "
        ":class:`syffutils.css.CSSVariablesDeclaration`.",
    )
