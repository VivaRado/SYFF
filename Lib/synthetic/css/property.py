...
from ..profiles import __knownNames as kn
#from ..profiles import knownNames as _knownNames
...
class Property(Base):
    ...
    def _setName(self, name):
        ...
        if wellformed:
            ...
            # validate
            if self._isValidating() and self._name not in kn:
                # self.valid = False
                self._log.warn(
    ...
    def validate(self):  # noqa: C901
        ...
        if self.name and self.value:
            ...
            if self.name in kn:
                ...
                valid, matching, validprofiles = validateWithProfile(
                ...
                # TODO: remove logic to profiles!
                    ...
                    if not profiles:
                        notvalidprofiles = '/'.join(defaultProfiles)
                    else:
