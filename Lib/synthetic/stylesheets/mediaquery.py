...
from ..css.value import MediaQueryValueProd
#import cssutils
import xml.dom
...
class MediaQuery(_NewBase):  # cssutils.util.Base):
    """
    ...
    def _getMediaText(self):
        return _ser.do_stylesheets_mediaquery(self)
