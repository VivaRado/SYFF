...
from .helper import *
from .tokenize2 import *
from .cssproductions import *
#from .css.csscomment import CSSComment
    ...
    def parse(  # noqa: C901
        ...
        while True:
            ...
            if type_ == self.types.COMMENT:
                ...
                seq.append(
                    CSSComment(val), css.CSSComment, line, col
                )
...
class PreDef(object):
    ...
    def calc(toSeq=None, nextSor=False):
        return Prod(
            name='calcfunction',
            match=lambda t, v: 'calc(' == normalize(v),
            toSeq=toSeq,
            nextSor=nextSor,
        )
    ...
    def string(stop=False, nextSor=False):
        ...
        return Prod(
            ...
            toSeq=lambda t, tokens: (t[0], stringvalue(t[1])),
            stop=stop,
            nextSor=nextSor,
        )
    ...
    def uri(stop=False, nextSor=False):
        ...
        return Prod(
            ...
            toSeq=lambda t, tokens: (t[0], urivalue(t[1])),
            stop=stop,
            nextSor=nextSor,
        )
    ...
    def variable(toSeq=None, stop=False, nextSor=False, toStore=None):
        return Prod(
            name='variable',
            match=lambda t, v: 'var(' == normalize(v),
            toSeq=toSeq,
            toStore=toStore,
            stop=stop,
            nextSor=nextSor,
